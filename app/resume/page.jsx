...
const about = {
  ...
  info: [
    ...
    {
      fieldName: "Email",
      fieldValue: "syachrilbls99@gmail.com",
    },
    {
      fieldName: "Freelance",
...
const experience = {
  ...
  items: [
    ...
    {
      company: "Family Battery",
      position: "Mechanic",
      duration: "2018 - 2021",
    },
    {
      company: "PT.Indah Cargo Logistics",
      position: "Staff",
      duration: "2021",
    },
    {
    ...
    {
      company: "PT.Bangun Ruang Teknologi",
...
const education = {
  ...
  items: [
    ...
    },
    {
      ...
      degree: "Certified Front-End Web Development",
      duration: "2023",
    },
    {
...
const Resume = () => {
  return (
    ...
    >
      <div className="container mx-aauto">
          ...
          <div className="min-h-[70vh] w-full">
            ...
            <TabsContent value="about" className="w-full text-center xl:text-left">
              <div className="flex flex-col gap-[30px]">
                ...
                <ul className="grid grid-cols-1 xl:grid-cols-2 gap-y-6 max-w-[620px] ms-auto xl:mx-0">
